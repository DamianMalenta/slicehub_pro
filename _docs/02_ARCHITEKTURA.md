...
| Ścieżka | Status |
|---------|--------|
| `payments/settle.php` | ✅ **WRAPPER (F1 · 2026-07-07)** — cienki HTTP adapter nad `core/SettlementEngine.php`; brak UI (split F2). Outbox: `order.completed` lub `payment.settled`. Produkcja POS: `pos/engine.php#settle_and_close` → ten sam silnik. |
